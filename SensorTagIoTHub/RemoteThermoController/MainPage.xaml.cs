...
using System.IO;
//Required for Stepper motor
using Windows.Devices.Gpio;
using System.Threading;

namespace RemoteThermoController
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            DataContext = this;
            //Init Stepper motor GPIO
            initGpio();
            // Call the IoTHub Data receive Task
            ...
            lock (sync)
            {
                motorrotate = new Task(() =>
                {
                    ...
                    while (g_bThreadActive)
                    {
                        ...
                        mre.WaitOne(0);  // this Wait value determines the rotation speed of the motor
                ...
                while (true)
                {
                    try
                    {
                        ...
                        if (receivedMessage != null)
                        {
                            ...
                            Debug.Write(messageData);
                            await deviceClient.CompleteAsync(receivedMessage);
                            if (messageData.Equals("On"))
                            {
                                g_bThreadActive = true;
                                if (!motoron)
                                {
...
private void Timer_Tick(object sender, object e)
        {
            ...
            Debug.WriteLine("X: " + accel_x + "  " + "Y: " + accel_y + "  " + "Z: " + accel_z+ "  m/s^2");
            /* Display the results (magnetic vector values are in micro-Tesla (uT)) */
            Debug.WriteLine("MAG  ");
            Debug.WriteLine("X: " + mag_x + "  " + "Y: " + mag_y + "  " + "Z: " + mag_z + "  uT");
            /* Display the results (gyrocope values in rad/s) */
            Debug.WriteLine("GYRO  ");
            Debug.WriteLine("X: " + gyro_x + "  " + "Y: " + gyro_y + "  " + "Z: " + gyro_z + "  rad/s");
            /* Display the pressure sensor results (barometric pressure is measure in hPa) */
            /* Display atmospheric pressure in hPa */
                Debug.WriteLine("PRESS :" + Pressure + " hPa ");
                Debug.WriteLine("TEMP :" + AmbiTemp + " C ");
                Debug.WriteLine("HUMIDITY :" + humid);
                SensorData SensorDataObj = new SensorData(accel_x, accel_y, accel_z,mag_x,mag_y,mag_z,gyro_x,gyro_y,gyro_z,
                    Pressure,AmbiTemp, humid, System.DateTime.Now.ToString("dd-MMM-yyyy HH:mm:ss tt"));
                    ...
                    if (characteristic.CharacteristicProperties.HasFlag(GattCharacteristicProperties.Notify))
                    {
                        switch (sensor)
                        {
                            ...
                            case (KEYS):
                                ...
                                ChillerTitle.Foreground = new SolidColorBrush(Colors.Green);
                                break;
                            default:
                                break;
                        }
        ...
        private async void disableSensor(int sensor)
        {
            ...
            switch (sensor)
            {
                ...
                case (GYROSCOPE):
                    ...
                    break;
                case (KEYS):
                    ChillerTitle.Foreground = new SolidColorBrush(Colors.White);
